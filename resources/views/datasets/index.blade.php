...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('datasets.create') }}" class="btn btn-sm btn-primary"><i class="bi bi-plus-lg me-1"></i>New Dataset</a>
        @endcanany
    </div>
    <div class="card-body">
...
@push('scripts')
<script>
vpDataTable('#datasetsTable', '{{ route('datasets.datatable') }}', [
    { data: 'code', name: 'code' },
    { data: 'name', name: 'name' },
