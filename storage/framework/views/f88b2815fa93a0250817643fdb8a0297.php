    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .lg-bg::before {
            ...
            background-image: url('<?php echo e(asset('images/landing/bg-hero.jpg')); ?>');
...
<header class="floating-header d-flex align-items-center justify-content-between">
    <a href="<?php echo e(route('landing')); ?>" class="brand d-flex align-items-center gap-2 text-decoration-none">
        <?php if($logoUrl): ?>
        ...
        <span>
            ...
            <span class="brand-slogan d-none d-sm-block"><?php echo e($tagline); ?></span>
        </span>
    </a>
    <div class="d-flex align-items-center gap-2">
        <div class="dropdown lang-switch">
            <button class="btn dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="bi bi-globe me-1"></i><?php echo e(app()->getLocale() === 'sw' ? 'Kiswahili' : 'English'); ?>

            </button>
            <ul class="dropdown-menu dropdown-menu-end">
                <li><a class="dropdown-item <?php echo e(app()->getLocale() === 'en' ? 'active' : ''); ?>" href="<?php echo e(route('locale.switch', 'en')); ?>">English</a></li>
                <li><a class="dropdown-item <?php echo e(app()->getLocale() === 'sw' ? 'active' : ''); ?>" href="<?php echo e(route('locale.switch', 'sw')); ?>">Kiswahili</a></li>
            </ul>
        </div>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-login-pill"><?php echo e(__('Login')); ?></a>
    </div>
</header>
...
<section class="hero">
    <div class="container" style="max-width:1180px">
        <div class="row align-items-center g-5">
            ...
            <div class="col-lg-5">
                <span class="badge-pill"><span class="dot"></span><?php echo e(__('MINISTRY OF INDUSTRY AND TRADE')); ?></span>
                <h1 class="mt-4 mb-3">
                    <?php echo e(__('Reliable Industry & Trade Data')); ?><br>
                    <span class="accent"><?php echo e(__('for a Growing Tanzania')); ?></span>
                </h1>
                <p class="lead mb-4"><?php echo e($tagline); ?> — <?php echo e(__('institutions report once, the Ministry and the public use trusted data everywhere.')); ?></p>
                <div class="d-flex gap-3 flex-wrap mb-4">
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-hero"><?php echo e(strtoupper(__('Sign in to the portal'))); ?> &nbsp;<i class="bi bi-arrow-right"></i></a>
                    <a href="#channels" class="btn btn-ghost"><?php echo e(__('Reporting channels')); ?></a>
                </div>
                <div class="chips mb-4">
                    <span><?php echo e(__('Data Catalogue')); ?></span>
                    <span><?php echo e(__('Approval Workflow')); ?></span>
                    <span><?php echo e(__('Reports & Analytics')); ?></span>
                </div>
                <div class="stats-strip d-flex gap-4 gap-md-5">
                    <div><div class="num"><?php echo e($stats['institutions']); ?><em>+</em></div><div class="lbl"><?php echo e(__('Institutions')); ?></div></div>
                    <div><div class="num"><?php echo e($stats['datasets']); ?><em>+</em></div><div class="lbl"><?php echo e(__('Datasets')); ?></div></div>
                    <div><div class="num"><?php echo e($stats['published']); ?><em>+</em></div><div class="lbl"><?php echo e(__('Published reports')); ?></div></div>
                </div>
            </div>
                ...
                <div class="inst-stack">
                    ...
                    <div class="inst-card manual" tabindex="0">
                        <div class="ic-head">
                            ...
                            <div>
                                <h3><?php echo e(__('DATA SUBMISSION')); ?></h3>
                                <div class="ic-sub"><?php echo e(__('Portal & CSV reporting — institutions under the Ministry')); ?></div>
                            </div>
                            <div class="ic-count">
                                <div class="n"><?php echo e($manualInstitutions->count()); ?></div>
                                <div class="t"><?php echo e(__('Institutions')); ?></div>
                            </div>
                        </div>
                        <div class="ic-hint"><i class="bi bi-chevron-down me-1"></i><?php echo e(__('Touch to view the institutions on this channel')); ?></div>
                        <div class="inst-details">
                            <?php $__empty_1 = true; $__currentLoopData = $manualInstitutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="inst-row">
                                    <span class="code-badge"><?php echo e($institution->code); ?></span>
                                    <div>
                                        <div class="nm"><?php echo e($institution->name); ?></div>
                                        <div class="meta">
                                            <?php echo e($institution->contact_email ?? __('Ministry of Industry and Trade')); ?>

                                            &nbsp;·&nbsp; <?php echo e($institution->datasets_count); ?> <?php echo e(__('Datasets')); ?>

                                        </div>
                                        <div>
                                            <?php $__currentLoopData = $institution->datasets->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ds): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <span class="ds-chip"><?php echo e($ds->code); ?> · <?php echo e(ucfirst($ds->frequency)); ?></span>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </div>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="inst-empty"><?php echo e(__('No institutions on this channel yet.')); ?></div>
                            <?php endif; ?>
                        </div>
                        <a href="<?php echo e(route('login')); ?>" class="cta"><?php echo e(__('Submit Data')); ?> <i class="bi bi-arrow-right ms-1"></i></a>
                    </div>
                    ...
                    <div class="inst-card api" tabindex="0">
                        <div class="ic-head">
                            ...
                            <div>
                                <h3><?php echo e(__('API INTEGRATION')); ?></h3>
                                <div class="ic-sub"><?php echo e(__('System-to-system reporting — institutions under the Ministry')); ?></div>
                            </div>
                            <div class="ic-count">
                                <div class="n"><?php echo e($apiInstitutions->count()); ?></div>
                                <div class="t"><?php echo e(__('Institutions')); ?></div>
                            </div>
                        </div>
                        <div class="ic-hint"><i class="bi bi-chevron-down me-1"></i><?php echo e(__('Touch to view the institutions on this channel')); ?></div>
                        <div class="inst-details">
                            <?php $__empty_1 = true; $__currentLoopData = $apiInstitutions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $institution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="inst-row">
                                    <span class="code-badge"><?php echo e($institution->code); ?></span>
                                    <div>
                                        <div class="nm"><?php echo e($institution->name); ?></div>
                        ...
                        <a href="<?php echo e(route('login')); ?>" class="cta"><?php echo e(__('Get API Access')); ?> <i class="bi bi-arrow-right ms-1"></i></a>
                    </div>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="info-card">
                    ...
                    <h5 class="mt-2"><?php echo e(__('Data Catalogue')); ?></h5>
                    <p><?php echo e(__('Each institution reports against a pre-defined data catalogue configured for its mandate, ensuring consistent and validated data every period.')); ?></p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="info-card">
                    <i class="bi bi-diagram-2"></i>
                    <h5 class="mt-2"><?php echo e(__('Approval Workflow')); ?></h5>
                    <p><?php echo e(__('Data passes an internal institutional approval chain — officer, supervisor and accounting officer — before Ministry review and publication.')); ?></p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="info-card">
                    <i class="bi bi-bar-chart"></i>
                    <h5 class="mt-2"><?php echo e(__('Reports & Analytics')); ?></h5>
                    <p><?php echo e(__('Dashboards, compliance tracking and consolidated reports turn submitted data into decisions for the Ministry and stakeholders.')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<footer class="landing-footer text-center small pb-4">
    <?php echo e(__('Copyright')); ?> © <?php echo e(date('Y')); ?> <?php echo e(__('Ministry of Industry and Trade')); ?> | <?php echo e($siteName); ?>
...
<?php /**PATH C:\xampp\htdocs\viwanda-portal\resources\views/landing.blade.php ENDPATH**/ ?>