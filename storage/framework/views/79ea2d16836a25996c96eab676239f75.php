<?php $__env->startSection('title', 'New Submission'); ?>
...
<form method="POST" action="<?php echo e(route('submissions.store')); ?>" id="batchForm">
<?php echo csrf_field(); ?>
        ...
        <div class="row g-3">
            <div class="col-md-4">
                ...
                <select id="periodSelect" class="form-select" required>
                    ...
                    <option value="<?php echo e($p->name); ?>" data-frequency="<?php echo e(strtolower($p->frequency)); ?>"><?php echo e($p->name); ?>

                        (<?php echo e(ucfirst($p->frequency)); ?>)</option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <input type="hidden" name="reporting_period" id="periodInput" value="<?php echo e(old('reporting_period')); ?>">
                <div class="form-text">Configured by your administrator under Data Catalogue → Submission Periods.</div>
                <?php else: ?>
                <input name="reporting_period" id="periodInput" class="form-control" placeholder="e.g. <?php echo e(now()->format('Y')); ?> - Q<?php echo e((int) ceil(now()->month/3)); ?>" value="<?php echo e(old('reporting_period')); ?>" required>
            ...
            <div class="col-md-5">
                ...
                <select name="consumers[]" class="form-select" multiple size="4">
                    <?php $__currentLoopData = $consumers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($c->code); ?>" <?php if(in_array($c->code, old('consumers', []))): echo 'selected'; endif; ?>><?php echo e($c->code); ?><?php echo e($c->name ? ' — '.$c->name : ''); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            ...
            <div class="col-md-3">
                ...
                <input name="transaction_reference" class="form-control" placeholder="Prevents duplicates" value="<?php echo e(old('transaction_reference')); ?>">
            </div>
        </div>
    </div>
</div>
...
?>
<script>
const DATASETS = <?php echo json_encode($datasetPayload, 15, 512) ?>;
const PRESELECT = <?php echo json_encode($preselect, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\viwanda-portal\resources\views/submissions/create.blade.php ENDPATH**/ ?>